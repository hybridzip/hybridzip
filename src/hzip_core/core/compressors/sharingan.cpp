...
#include <hzip/core/preprocessor/png_bundle.h>
#include <hzip/errors/compression.h>
#include <hzip/core/models/paeth.h>
#include <hzip/core/models/first_order_context.h>

HZ_Blob *hzcodec::Sharingan::compress(HZ_Blob *blob) {
...
HZ_Blob *hzcodec::Sharingan::decompress(HZ_Blob *blob) {
    return nullptr;
}

HZ_MState *hzcodec::Sharingan::train(HZ_Blob *blob) {
    return nullptr;
}
