...
void cpp_dotenv::Parser::parse(istream& is, const bool overwrite, const bool interpolate)
{
...
void cpp_dotenv::Parser::parse_dotenv(istream& is, const bool overwrite)
{
...
void cpp_dotenv::Parser::parse_line()
{
...
void cpp_dotenv::Parser::resolve_vars()
{
...
void cpp_dotenv::Parser::expand_escape()
{
    for (const pair<string, SymbolRecord>& symbol: symbols_table)
    {
        // std::pair.second returns a copy of the second element, and a
...
void cpp_dotenv::Parser::register_env(const bool overwrite) const
{
    for (const pair<string, SymbolRecord>& symbol: symbols_table)
    {
        const string& key = symbol.first;
...
void cpp_dotenv::Parser::resolve_local_vars()
{
    for (const pair<string, SymbolRecord>& symbol: symbols_table)
    {
        // std::pair.second returns a copy of the second element, and a
...
void cpp_dotenv::Parser::resolve_external_vars()
{
    for (const pair<string, SymbolRecord>& symbol: symbols_table)
    {
        // std::pair.second returns a copy of the second element, and a
...
void cpp_dotenv::Parser::resolve_undefined_vars()
{
    for (const pair<string, SymbolRecord>& symbol: symbols_table)
    {
        // std::pair.second returns a copy of the second element, and a
...
void cpp_dotenv::Parser::resolve_unresolvable_vars()
{
    for (const pair<string, SymbolRecord>& symbol: symbols_table)
    {
        // std::pair.second returns a copy of the second element, and a
...
void cpp_dotenv::Parser::report_undefined_vars()
{
...
void cpp_dotenv::Parser::report_unresolvable_vars()
{
    // Iterate over all the original existing references (for having access to
    // original location data)
    for (const pair<string, ReferenceRecord>& reference: references_table)
...
void cpp_dotenv::Parser::walk_line(const string& line, tree::ParseTreeListener& listener)
{
